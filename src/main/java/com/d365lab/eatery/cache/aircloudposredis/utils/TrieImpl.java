...
public final class TrieImpl implements Trie<String>{
	...
	private static TrieImpl menuTrieInstance = new TrieImpl();
	private static TrieImpl customerTrieInstance = new TrieImpl();
	...
	public static TrieImpl getInstance(String trieType) {
		TrieImpl instance = new TrieImpl();
		switch(trieType) {
			case "MENU":
				instance =  menuTrieInstance;
				break;
			case "CUSTOMER":
				instance = customerTrieInstance;
				break;
		}
		return instance;
	}
	...
	public void clear(String type) {
		switch (type) {
			case "MENU":
				menuTrieInstance = null;
				menuTrieInstance = new TrieImpl();
				break;
			case "CUSTOMER":
				customerTrieInstance = null;
				customerTrieInstance = new TrieImpl();
				break;
		}
	}
